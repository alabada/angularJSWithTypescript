...
.directive('oiSelect', ['$document', '$q', '$timeout', '$parse', '$interpolate', '$injector', '$filter', '$animate','$templateCache', 'oiUtils', 'oiSelect', function($document, $q, $timeout, $parse, $interpolate, $injector, $filter, $animate,$templateCache, oiUtils, oiSelect) {
    ...
    return {
        ...
        template: $templateCache.get ( 'src/template.html' ),
        require: 'ngModel',
        scope: {},
