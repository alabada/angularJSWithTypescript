/*! w5cValidator v2.4.21 2016-06-28 */
/**
 * edit by wenhui.gao 2016-8-18
 * 修改点 搜索 ++++
 */
            ...
            function ($parse, w5cValidator, $timeout) {
                return {
                    ...
                    link      : function (scope, form, attr, ctrls) {
                        ...
                        /*++++add    by wenhui.gao*************/
                        //修改在 w5cFormValidateRules 有值时 设置规则
                        var rules = scope.$eval(attr.w5cFormValidateRules)
                        if (attr.w5cFormValidateRules) {
                            scope.$watch(attr.w5cFormValidateRules, function (newValue) {
                                w5cValidator.setRules(newValue)
                            }, true)
                        }
                        /******************************/
