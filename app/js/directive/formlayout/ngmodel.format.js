    ...
    angular.module('ngmodel.format', [])
        .constant("modelFormatConfig", {
            ...
            "uppercase":{
                ...
                "parser": function(args) {
                    return args.$viewValue ? args.$viewValue.toUpperCase() : undefined;
                },
                "isEmpty": function(value) {
                    return !value.$modelValue;
                }
            ...
            "lowercase":{
                ...
                "parser": function(args) {
                    return args.$viewValue ? args.$viewValue.toLowerCase() : undefined;
                },
                "isEmpty": function(value) {
                    return !value.$modelValue;
                }
            ...
            "capitalize":{
                ...
                "parser": function(args) {
                    var capitalize = function(input){
                        var output = input.replace(/([a-zA-Z])([a-zA-Z]*)/gi, function(matched, $1, $2){
                                          return  $1.toUpperCase() + $2;
                                      });
                        return output
                    }
                    return args.$viewValue ?  capitalize(args.$viewValue) : undefined;
                },
                "isEmpty": function(value) {
                    return !value.$modelValue;
                }
            ...
            function(modelFormatConfig, $filter, $parse) {
                return {
                    ...
                    link: function(scope, element, attrs, ctrl) {
                        ...
                        /*如果类型为uppercase lowercase capitalize 添加text-transform样式*/
                        ...
                        // console.log(isTextTransform )

                        if( isTextTransform ){
                          element.css("text-transform", attrs.modelFormat);
                        }
