...
define(["app",
    "js/directive/objectTable/objectTableUtilService",
    "js/directive/objectTable/objectTableSortingCtrl"], function (app) {

    app.controller('objectTableCtrl', ['$scope', '$timeout', '$element', '$attrs', '$http', '$compile', '$controller', 'objectTableUtilService',
