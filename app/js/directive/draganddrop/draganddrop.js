...
define(["app"], function (app) {
    ...
    app.directive("drag", ["$rootScope", "dragAndDrop", "$controller", '$document',"$compile", function ($rootScope, dragAndDrop, $document) {
        return {
            restrict: 'EA',
            link: function (scope, element, attrs, $element) {
                 ...
                 *
                 */
                var dragInclude, dragItems;
                dragItems = scope.$eval(attrs.dragItems);
                //

                if (false) {
                    //dragInclude = (angular.element("<div>" + element.html() + "</div>"))(scope)
                    dragInclude =  angular.element(element).clone();
                    //dragInclude.addClass("clone");
                    //cloneEl.addClass("hidden");
                    //dragInclude.addClass(element.attr("class"));
                    /*dragInclude = element;*/
                } else {
                    dragInclude = scope.$eval(attrs.dragInclude);
                }
                if (true) {
